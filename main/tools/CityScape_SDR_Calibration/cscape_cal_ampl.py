...
class usrp_cal_amp(grc_wxgui.top_block_gui):
	...
	font.SetWeight(wx.FONTWEIGHT_BOLD)
        ...
        self.u.set_center_freq(input_freq_slider + usrp_freq_offset_slider, 0)
        self.u.set_gain(usrp_gain_slider, 0)
        self.u.set_antenna('RX2', 0)
        self.u.set_bandwidth(600000, 0)
	self.u_mboard_serial = self.u.get_usrp_info()["mboard_serial"]
	self.u_dboard_serial = self.u.get_usrp_info()["rx_serial"]
	self.u_dboard_id = self.u.get_usrp_info()["rx_id"].split(" ")[0]
	self.u_dboard_id = self.u_dboard_id.strip(", ")
    ...
    def set_usrp_gain_slider(self, usrp_gain_slider):
        ...
        self.u.set_gain(self.usrp_gain_slider, 0)
    ...
    def set_usrp_freq_offset_slider(self, usrp_freq_offset_slider):
        ...
        self.u.set_center_freq(self.input_freq_slider + self.usrp_freq_offset_slider, 0)
        self._wrapup_text_box_1.SetLabel("\n   USRP LO freq: {0:.0f}\n".format(
        	self.input_freq_slider + self.usrp_freq_offset_slider))
