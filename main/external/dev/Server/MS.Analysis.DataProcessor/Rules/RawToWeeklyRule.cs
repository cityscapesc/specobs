...
{    
    ...
    public class RawToWeeklyRule : AggregationRule
    {
        public RawToWeeklyRule(SpectrumDataProcessorStorage spectrumDataProcessStorage)
        ...
        {
            IEnumerable<SpectrumCalibration> aggregatedSpectralData = this.NormalizeSpectralDataByTimeGranularity(spectralData, TimeRangeKind.Weekly, measurementStationKey);
