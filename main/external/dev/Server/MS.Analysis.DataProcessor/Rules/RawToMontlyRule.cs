...
namespace Microsoft.Spectrum.Analysis.DataProcessor.Rules
{
    ...
    public class RawToMonthlyRule : AggregationRule
    {
        public RawToMonthlyRule(SpectrumDataProcessorStorage spectrumDataProcessStorage)
        ...
        {
            IEnumerable<SpectrumCalibration> aggregatedSpectralData = this.NormalizeSpectralDataByTimeGranularity(spectralData, TimeRangeKind.Monthly, measurementStationKey);
