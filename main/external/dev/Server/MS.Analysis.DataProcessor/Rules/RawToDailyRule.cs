...
namespace Microsoft.Spectrum.Analysis.DataProcessor.Rules
{
    ...
    public class RawToDailyRule : AggregationRule
    {
        public RawToDailyRule(SpectrumDataProcessorStorage spectrumDataProcessStorage)
        ...
        {
            IEnumerable<SpectrumCalibration> aggregatedSpectralData = this.NormalizeSpectralDataByTimeGranularity(spectralData, TimeRangeKind.Daily, measurementStationKey);
