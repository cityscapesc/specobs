...
namespace Microsoft.Spectrum.Scanning.Scanners
{
    ...
    public class SettingsConfigurationSection : ConfigurationSection
    {
        ...
        [ConfigurationProperty("cityscapeCalibrationFile", IsRequired = true)]
        public string CityscapeCalibrationFile
        {
            get { return (string)base["cityscapeCalibrationFile"]; }
        }
        ...
        public string CityscapeCalibrationDataFileFullPath
        {
            get
            {
                return Environment.ExpandEnvironmentVariables(this.SettingsDirectory) + "\\" + this.CityscapeCalibrationFile;
            }
        }
    }
}